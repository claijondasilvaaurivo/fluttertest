...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    loginAppAuthUserSubject.add(
      LoginAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LoginAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LoginAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LoginAppAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    loginAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
